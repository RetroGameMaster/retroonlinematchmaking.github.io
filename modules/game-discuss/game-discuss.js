...
function renderGamercard(profile, isChat = false) {
  ...
  if (profile?.gamercard_bg_type === 'image') {
    ...
    bgStyle = `background-image: url('${profile.gamercard_bg_value}'); background-size: cover; background-position: center; opacity: 0.1;`;
    ...
    bgStyle = `background-color: ${profile?.gamercard_bg_value || '#1f2937'}; opacity: 0.1;`;
  }
