...
import { supabase, getCurrentUser, isAdmin, getGameById } from '../../lib/supabase.js';
...
export function initModule(rom) {
    console.log('Admin module initialized with rom:', rom);
    window.rom = rom;
    loadAdminPanel();
}

// NEW: Export editGame function for direct access
...
async function loadAdminPanel() {
    ...
    // Create the admin interface structure
    ...
    appContent.innerHTML = `
        <div class="max-w-7xl mx-auto p-4">
            <div class="mb-6">
                <a href="#/home" class="inline-flex items-center text-cyan-400 hover:text-cyan-300 mb-6">
                    ← Back to Home
                </a>
            </div>
...
function createGameEditForm(game) {
    ...
    const isUserAdmin = currentUser && adminEmails.includes(currentUser.email?.toLowerCase());
