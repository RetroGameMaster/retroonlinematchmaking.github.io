...
function initSubmitGame(rom) {
  console.log('🎮 Submit Game Module Initialized');
  ...
  // Add new connection method button
    ...
    const imageHTML = `
      <div class="form-section fade-in">
        ...
        <div class="mb-6">
          ...
          <div class="file-upload-area bg-gray-900 border-2 border-dashed border-gray-600 rounded-lg p-6 text-center mb-4 cursor-pointer hover:border-cyan-500 transition-colors" id="coverUploadArea">
            <div class="mb-4">
            ...
            <button type="button" onclick="document.getElementById('coverImage').click()" class="bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-2 rounded mt-2">Choose File</button>
          ...
          <div id="coverPreview" class="hidden">
            ...
            <div class="flex items-center gap-4">
              ...
              <button type="button" onclick="removeCoverImage()" class="text-red-400 hover:text-red-300">✕ Remove</button>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="file-upload-area bg-gray-900 border-2 border-dashed border-gray-600 rounded-lg p-6 text-center mb-4 cursor-pointer hover:border-purple-500 transition-colors" id="screenshotsUploadArea">
            <div class="mb-4">
              <svg class="w-12 h-12 mx-auto text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button type="button" onclick="document.getElementById('screenshotImages').click()" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded mt-2">Choose Files</button>
  ...
  function updateScreenshotsPreview() {
    ...
    selectedScreenshots.forEach((file, index) => {
      ...
      reader.onload = (e) => {
        ...
        div.innerHTML = `
          <img src="${e.target.result}" alt="Screenshot ${index + 1}" class="w-full h-32 object-cover rounded-lg border border-gray-600">
          <button type="button" onclick="removeScreenshot(${index})" class="absolute top-0 right-0 bg-red-600 text-white w-6 h-6 rounded-full">✕</button>
        `;
